  ...
  return (
    <>
      ...
      <div className='bg-transparent landscape:w-1/3 portrait:w-2/3 aspect-square overflow-hidden relative'>
        ...
        <div className=' bg-[url("../subhashis_das_image.png")] bg-top bg-cover bg-no-repeat w-full h-full scale-100 hover:scale-110 transition-all duration-300 ease-linear'>
          {/* rounded-full */}
        </div>
      </div>
    </>
