      ...
      <div id="contactme" className="main_section h-[90svh] px-6 lg:px-10 pt-20 lg:pt-15">
        ...
        <div>
          <form className='block' ref={form} onSubmit={sendEmail}>
            ...
            <input type="submit" value="Submit" className='block landscape:w-1/6 portrait:w-1/2 mx-auto outline font-bold text-xl py-4 transition-all duration-1000 ease-in-out' />
          </form>
        </div>
      </div>
    </>
